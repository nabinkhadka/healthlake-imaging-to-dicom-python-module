...
class AHIFrameFetcher:
    ...
    def __init__(self, InstanceId , aws_access_key , aws_secret_key , aws_session_token , aws_region , AHI_endpoint = None , ahi_client = None):
        ...
        self.process = Process(target = self.ProcessJobs , args=(self.FetchJobs,self.FetchJobsCompleted, self.FetchJobsInError ,  self.aws_access_key , self.aws_secret_key , self.aws_session_token , self.aws_region , self.AHI_endpoint , self.ahi_client))
        self.process.start()
    ...
    def ProcessJobs(self,FetchJobs : Queue, FetchJobsCompleted : Queue , FetchJobsInError : Queue ,   aws_access_key : str = None , aws_secret_key : str = None , aws_session_token : str = None , aws_region : str = None , AHI_endpoint : str = None , ahi_client = None):  
        if ahi_client is None: 
            ahi_client = AHIClientFactory( aws_access_key= aws_access_key , aws_secret_key=aws_secret_key , aws_session_token=aws_session_token , aws_region=aws_region , aws_accendpoint_url=AHI_endpoint )
