...
class AHItoDICOM:
    ...
    def __init__(self, aws_access_key : str =  None, aws_secret_key : str = None , aws_session_token : str = None , aws_region : str = None , AHI_endpoint : str = None , fetcher_process_count : int = None , dicomizer_process_count : int = None ) -> None:
        """
        ...
        :param aws_region: Optional AWS region name.
    ...
    def DICOMizeByStudyInstanceUID(self, datastore_id : str = None , study_instance_uid : str = None , header_only : bool = False):
        ...
        client = AHIClientFactory(self.aws_access_key ,  self.aws_secret_key , self.aws_session_token , self.aws_region , self.AHI_endpoint )
    ...
    def _initFetchAndDICOMizeProcesses(self, AHI_metadata):
        ...
        for x in range(self.fetcherProcessCount): 
            ...
            self.frameFetcherThreadList.append(AHIFrameFetcher(str(x), self.aws_access_key , self.aws_secret_key , self.aws_session_token , self.aws_region , self.AHI_endpoint  )) 
        for x in range(self.DICOMizerProcessCount):
